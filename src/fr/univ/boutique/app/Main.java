...
import fr.univ.boutique.modele.ProduitFragile;
import fr.univ.boutique.modele.exception.CommandeModifieeException;
import fr.univ.boutique.notification.ConsoleNotificationService;

/**
 * Demonstration exigee en Partie B.5 :
 * - Cree une commande
 * - Affiche son total
 * - Change sa livraison
 * - La valide
 * - Verifie l'interdiction de modification apres validation
 */
public class Main {
